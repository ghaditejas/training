<div class="section clearfix section-colored7">
    <div class="container">
        <div class="Download_Cont_Top_Left left">
            <img src="<?php echo base_url()?>assets/images/icon5.png" alt=""/> 
            <h1 style="display:inline;">FREE: Men Are From Mars</h1> 
...
<footer class="footer_wrapper">
    <div class="container">
        <div class="Footer_Cont_Top clearfix">
            <span class="left">
                   <img src="<?php echo base_url()?>assets/images/foot_logo.png" alt=""/>
            </span>
        ...
        <div class="Footer_Cont_Top3 clearfix">
            <div class="Foot_Link1">
                ...
                <div class="Foot_Link2">
                    ...
                    <p>Email: 
                        <a href="mailto:info@syd.vitalpartners.com.au" target="_blank">info@syd.vitalpartners.com.au</a>
                    </p>
                </div>
                <div class="Foot_Link2">
                    ...
                    <p>Email: 
                        <a href="mailto:can@syd.vitalpartners.com.au" target="_blank">can@syd.vitalpartners.com.au</a>
                    </p>
                </div>
            </div>
            <div class="Foot_Link1">
                    ...
                    <ul>
                        <li class="left">
                            ...
                            <div class="Page_Link left">
                                <a href="#">http://t.co/hGCgHEU6If</a></div>
                            <div class="Page_Link right"> 1 week ago</div>
                        </li>
                        <li class="left">
                            <p>Are you being vulnerable to find love? via offline dating agency Sydney Canberra Vital Partners </p> 
                            <div class="Page_Link left">
                                <a href="#">http://t.co/hGCgHEU6If</a>
                            </div>
    ...
    <div class="section section-colored10">
        <div class="container">
            <div class="Foot_Link8 ">
                <a href="#">Who Designed This Site?</a> 
                <a href="#">Who  Built This Site?</a>
            </div>
        </div>
    </div>
</footer>
