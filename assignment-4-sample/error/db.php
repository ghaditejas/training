...
<!--[if gt IE 8]> <html class="no-js gt-ie8 ie" lang="en" dir="ltr"><![endif]-->
    ...
    <head>
        ...
        <title>Assignment 4 | Category - Products</title>
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <center><br /><h3>Database Connection Error. Please check database settings.</h3><br /></center>
        ...
        <script type="text/javascript" src="../js/plugins/jquery-validation/dist/jquery.validate.min.js"></script>
